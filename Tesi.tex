...
di \emph{necessarietà} e \emph{possibilità}. Nello specifico
presenteremo alcuni sistemi formali atti a formalizzare tali nozioni,
insieme alle loro semantiche nello stile di Kripke e ne esporremo alcune proprietà.
...
ometteremo spesso le parentesi usando le convenzioni descritte in \cite{TortoraConv}.
...
questi ultimi sono presi dal sistema di calcolo proposizionale definito in \cite{Tortora}.
...
\end{theorem}
\begin{proof}
Una dimostrazione può essere trovata in \cite{Tortora}, e può essere facilmente
...
È noto, e una discussione approfondita di questo argomento si può trovare in \cite{MendelsonAdeq},
...
\bibitem{MendelsonAdeq} E. Mendelson, \textit{Introduction to Mathematical Logic}, [1964], Londra, Chapman \& Hall, $1997^{4}$, pp. 27-29.
...
\bibitem{TortoraConv} R. Tortora, \textit{Elementi di teoria degli insiemi}, Napoli, E.DI.S.U. - Napoli 1, 1989, p. 64.
\end{thebibliography}
